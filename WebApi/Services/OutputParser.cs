namespace WebApi.Services
{
    ...
    {
        public static IEnumerable<PlotJob> ParsePlotStatusOutput(string output)
        {
        ...
        public static ProcessState ParseProcessState(string output)
        {
        ...
        public static MemoryState ParseMemoryState(string output)
        {
        ...
        public static IEnumerable<CpuState> ParseCpuState(string output)
        {
        ...
        public static NodeStatus ParseNodeStatus(string output)
        {
        ...
        public static FarmStatus ParseFarmStatus(string output)
        {
